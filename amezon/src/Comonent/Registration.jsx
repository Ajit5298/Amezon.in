    ...
    <div>
      ...
      <div id="rform">
        <form>
          ...
          <input id="tel" type="tel" placeholder='Mobile number' /><br/>
          <label>Email (Optional)</label><br/>
          <input type="email" placeholder='ex: Email_ID@gmail.com'/><br/>
          <label>Password</label><br/>
          <input type="password" placeholder='At least 6 characters'/><br/>
          <span id="pmb">password must be at least 6 characters</span><br/>
          <span id="verify">To verify your number, we will send you a text message with a temporary code. Message and data rates may apply.</span><br/>
<button>Continue</button><br/>
<div id="last">
  <span>Already have an account? <a> Sign in</a></span><br/>
  <span>Buying for work? <a> Create a free business account</a></span><br/>
</div>
<div id="lastm">
  <span>By creating an account or logging in, you agree to Amazon’s<a> Conditions of Use</a> and<a> Privacy Policy</a></span>
</div>
